...
//        List<Member> content = results.getResults();
     ...
     *
     * left 조인을 할 경우 on절을 이용하고 일반 조인을 사용할 경우에는 where절을 사용하자.
     */
    @Test
...
//                .leftJoin(team).on(member.username.eq(team.name))
    ...
    /**
     * from 절의 서브쿼리는 지원하지 않는다. (from절의 서브쿼리.. 고민해봐야 한다.)
     * 1. 서브쿼리를 join으로 변경한다.
    ...
    /**
     * 생각보다 쓸일이 많을 꺼다... concat()에서 문자가 아닌 것들은 .stringValue()를 통해서 String으로 변환한다.
     */
    @Test
    public void concat() {
        // {username_age}
...
//                        member.age))
    ...
    /**
     * 초기 값을 넣을 경우(생성자에)는 무조건 조건을 체크해야될때 이다.
     *
     * @param usernameCond
     * @param ageCond
     * @return
...
//                .where(allEq(usernameCond, ageCond))
    ...
    /**
     * 함수적으로 분리하는게 이점이 크다.
     * BooleanExpression.class 등으로 선언 후 조합하거나 재사용이 가능해진다.
     * 
     * @param ageCond
     * @return
     */
